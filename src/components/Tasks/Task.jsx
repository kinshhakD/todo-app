...
function Task({ id, text, list, onRemove, onEdit, onCompleted, completed }) {

  const onChangeCheckbox = (e) => {

    onCompleted(list.id, id, e.target.checked)
  }
  // onClick={() => onCompleted(list.id, id)}
  return (
    <div className="tasks__items-row" key={id}>
      ...
      <span>{text}</span>
      {/* <input readOnly value={text} onChange={(e) => console.log(e.target.value)} /> */}
